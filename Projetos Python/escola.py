...
while True:
    ...
    print(f"Olá! Seja bem-vindo {nome_login}! Escolha uma opção:")
    ...
    if opcao_selecionada == 0: #Sai do programa
        ...
        while True:
            ...
            for aluno in lista_alunos:
                if nome_aluno_pesquisado.upper() in aluno.nome.upper():
                    print(f"O(A) aluno(a) {aluno.nome} com a matrícula {aluno.matricula} e o documento {aluno.documento} consta na lista.")
                    controle_iteracao += 1
        ...
        while True:
            ...
            #Solicitando a saída para o usuário    
            controle_insert_prof = input("Deseja incluir mias um(a) professor(a)? (Digite 'n' ou 'N' para sair) \n")
