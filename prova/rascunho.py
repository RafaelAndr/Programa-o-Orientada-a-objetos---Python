...
class Ponto:
    def __init__(self):
        self.__x = 0
        self.__y = 0
        self.__posicaoArbitrariaX = random.randint(0,10)
        self.__posicaoArbitrariaY = random.randint(0,10)
    ...
    def distanciaPontos(self,pX,pY):
        return math.sqrt(((self.__posicaoArbitrariaX - pX)**2) + ((self.__posicaoArbitrariaY - pY)**2))
